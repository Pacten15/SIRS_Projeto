...
try:
    ...
    print("ERROR: Import failed. Install dependencies with: pip3 install -r requirements.txt", file=sys.stderr)
    exit(1)
...
def print_help():
    ...
    print("    check     - Tests encrypted (infile), (src_key) is public, (dst_key) is private, no (outfile)")
